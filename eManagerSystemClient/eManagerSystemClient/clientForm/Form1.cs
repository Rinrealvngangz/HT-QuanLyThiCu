    ...
    public partial class Form1 : Form
    {
        ...
        public void Connect()
        {
          string hostName = Dns.GetHostName();
            ...
            IP = new IPEndPoint(IPAddress.Parse(currentIP), 3355);
        ...
        public void SendAcceptUser(string mssv,string name)
        {
                ...
                while (true)
                {
                    ...
                    switch ((string)Deserialize(receiveData.option))
                    {
                        ...
                        case "Send ShutDown":
                            ...
                            break;
                        case "Send MessAll":
                            string messageAll = (string)Deserialize(receiveData.data);
                            this.Invoke(new Action(() => { MessageBox.Show(this, messageAll); }));
                            break;
                        default:
                            break;
                    }
        ...
        {
            if(lblMaSo.Text != string.Empty && lblHoTen.Text !=string.Empty)
            {
               
                SendAcceptUser(lblMaSo.Text,lblHoTen.Text);
                cmdChapNhan.Enabled = false;
